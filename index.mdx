...
<Card title="Open the Quickstart" icon="arrow-right" href="/guides/quickstart/">
  Go straight to the install and first-run guide for PIXA.
</Card>

<Button href="https://github.com/soumyacodes007/Pixa/releases/tag/onramp" variant="secondary">
