...
<Button href="https://github.com/soumyacodes007/Pixa/releases/tag/onramp" variant="primary">
...
1. Download the latest PIXA release bundle from [GitHub Releases](https://github.com/soumyacodes007/Pixa/releases/tag/onramp).
...
The `.mcpb` bundle from [GitHub Releases](https://github.com/soumyacodes007/Pixa/releases/tag/onramp) is best for live demos and non-technical installs.
